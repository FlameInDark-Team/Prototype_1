...
const VerifierPortal = () => {
    ...
    const handleVerify = async (e) => {
        ...
        if (res.valid) {
            setIsModalOpen(true);
            addNotification('Verification Success', `Credential for ${res.data.studentName} verified on-chain.`, 'success');
        } else {
            addNotification('Verification Failed', 'The provided credential could not be verified.', 'warning');
        }
    };
